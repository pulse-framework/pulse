    ...
    ***************************************************************************** */
                ...
                if (job.dep) {
                    ...
                    subscribers.forEach(function (cC) {
                        ...
                        if (typeof cC.evaluated === 'object' &&
                            ...
                            var keys = Object.keys(cC.evaluated);
    ...
    var SubController = /** @class */ (function () {
        ...
        SubController.prototype.analyseDepsFunc = function (func) {
            ...
            return { mapToProps: mapToProps, deps: deps, evaluated: evaluated };
        };
        ...
        SubController.prototype.legacyMapData = function (func) {
            ...
            normalizeMap(func).forEach(function (_a) {
                ...
                var res = _this.global.subs.analyseDepsFunc(function () {
                    var _a;
        ...
        SubController.prototype.mapData = function (func, componentInstance, returnInfo) {
            ...
            var cC = this.get(componentInstance.__pulseUniqueIdentifier), deps = new Set(), evaluated = {}, mapToProps = false, legacy = false;
            ...
            // create subscription
            deps.forEach(function (dep) { return dep.subscribe(cC); });
            if (returnInfo)
                return { evaluated: evaluated, deps: deps, mapToProps: mapToProps, legacy: legacy };
            return evaluated;
        };
    ...
    function ReactWrapper(ReactComponent, depsFunc) {
        ...
        return /** @class */ (function (_super) {
            ...
            class_1.prototype.render = function () {
                var _a, _b;
                var props = __assign({}, this.props), cC = global.subs.get(this.__pulseUniqueIdentifier), customProp = global.config.mapDataUnderPropName;
                ...
                // METHOD (2) if custom prop is set and we were supplied a new mapData function
                    ...
                    props = __assign({}, props, (_a = {}, _a[customProp] = cC.depsFunc(global.contextRef), _a));
                }
                // METHOD (3) Pulse 2.2 map directly to props
                else if (cC.mappable) {
                    // concat current props with lastest pulse values
                    props = __assign({}, props, cC.depsFunc(global.contextRef));
                }
                // METHOD (4) we were supplied legacy mapData object, string notation 'collection/property'
                else if (this.legacy) {
                    props = __assign({}, props, (_b = {}, _b[customProp || 'pulse'] = this.legacyMapData(cC.depsFunc).evaluated, _b));
                }
