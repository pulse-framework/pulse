    ...
    ***************************************************************************** */
    ...
    var Runtime = /** @class */ (function () {
        ...
        Runtime.prototype.completedJob = function (job) {
            ...
            if (this.global.runningAction)
                this.global.runningAction.changes.add(job);
        };
        // ****************** End Runtime Events ****************** //
    ...
    var Module = /** @class */ (function () {
        ...
        Module.prototype.throttle = function (amount) {
            ...
            if (this.global.runningAction) {
                this.throttles.push(this.global.runningAction);
            }
            // after the certain amount has possed remove the throttle via filter
            setTimeout(function () {
                _this.throttles = _this.throttles.filter(function (action) { return action !== _this.global.runningAction; });
            }, amount);
        };
        Module.prototype.debounce = function (func, amount, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            action = this.global.runningAction;
