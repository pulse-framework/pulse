(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var Computed = /** @class */ (function () {
        ...
        Computed.prototype.ticket = function () { };
        return Computed;
    }());
    ...
    var RelationController = /** @class */ (function () {
        ...
        RelationController.prototype.cleanup = function (cleanupKey) {
            ...
            this.cleanupRefs[cleanupKey].forEach(function (uuid) { return delete _this.relations[uuid]; });
        ...
        RelationController.prototype.update = function (tickets) {
            ...
            tickets.forEach(function (ticket) {
                ...
                switch (relation.type) {
                    ...
                    //
                    case RelationTypes.DATA_DEPENDS_ON_DATA:
                        _this.privateIngestDataUpdate(relation.updateThis);
                        break;
                    //
                    case RelationTypes.DATA_DEPENDS_ON_GROUP:
                        _this.privateIngestDataUpdate(relation.updateThis);
        ...
        RelationController.prototype.parse = function (key) {
            return {
        ...
        RelationController.prototype.privateIngestDataUpdate = function (updateThis) {
            var parsed = this.parse(updateThis);
            this.global.runtime.ingest({
    ...
    var Dep = /** @class */ (function () {
        function Dep(global, name, rootProperty, propertyOnObject, tickets) {
            this.global = global;
            this.name = name;
    ...
    var Library = /** @class */ (function () {
        ...
        Library.prototype.ticket = function (collection, uuid, primaryKey) {
