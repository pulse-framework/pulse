    ...
    var Module = /** @class */ (function () {
        ...
        Module.prototype.preparePublicNamespace = function (root) {
            ...
            var namespaceWithMethods = Object.assign.apply(Object, [Object.create(this.methods),
                publicNamespace].concat(root.data, root.computed, root.actions));
        ...
        Module.prototype.getSelfContext = function () {
            ...
            // module only context
            var localContext = __assign({}, this.methods, { data: this.public.object, computed: this.public.object, routes: this.public.object.routes, local: this.root.local });
