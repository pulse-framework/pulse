    ...
    ***************************************************************************** */
    ...
    var Runtime = /** @class */ (function () {
        ...
        Runtime.prototype.ingest = function (job) {
            ...
            if (this.runningJob &&
                job.property === this.runningJob.property &&
                job.collection === this.runningJob.collection) ;
    ...
    var Reactive = /** @class */ (function () {
        ...
        Reactive.prototype.injectIntoPrototype = function (obj) {
    ...
    var Module = /** @class */ (function () {
        function Module(name, global, root) {
            ...
            var mutableKeys = Object.keys(root.data || {});
        ...
        Module.prototype.prepareNamespace = function (root) {
            ...
            var publicNamespace = {}, types = ['routes', 'indexes', 'local'];
            types.forEach(function (type) { return root[type] && (publicNamespace[type] = root[type]); });
            this.namespace = Object.assign(Object.create(this.methods), publicNamespace);
            return root;
        };
        Module.prototype.initRoutes = function (routes) {
            ...
            for (var routeName in routes) {
                if (!this.public.exists('routes'))
                    this.public.privateWrite('routes', {});
        ...
        Module.prototype.watch = function (property, callback) {
            if (!this.externalWatchers[property])
                ...
                this.externalWatchers[property].push(callback); // luka was here
        };
        Module.prototype.getSelfContext = function () {
            var globalContext = this.global.contextRef;
            // module only context
            var localContext = __assign({}, this.methods, { data: this.public.object, computed: this.public.object, routes: this.public.object.routes, local: this.namespace.local });
            ...
            return __assign({}, globalContext, localContext);
        };
    ...
    var SubController = /** @class */ (function () {
        ...
        SubController.prototype.subscribePropertiesToComponents = function (properties, componentUUID) {
            ...
            var provision = properties(this.getContextRef());
            ...
            var returnToComponent = properties(this.getContextRef());
            this.subscribingComponent = false;
            this.subscribingComponentKey = 0;
    ...
    var Pulse = /** @class */ (function () {
        ...
        Pulse.prototype.registerModules = function (root) {
            ...
            var aliasedProperties = self.modules.base.public.mutableProperties.concat(self.modules.base.keys.computed);
            for (var property in self.modules.base.public.object)
        ...
        Pulse.prototype.mapData = function (properties, instance, _config, pulseAlias) {
