(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var Reactive = /** @class */ (function () {
        ...
        Reactive.prototype.cleanse = function (object) {
            if (!object)
                object = this.object;
    ...
    var SubController = /** @class */ (function () {
        function SubController(cleanContext) {
        ...
        SubController.prototype.subscribePropertiesToComponents = function (properties, componentUUID) {
            ...
            var provision = properties(this.cleanContext);
            ...
            var returnToComponent = properties(this.cleanContext);
            this.subscribingComponent = false;
            this.subscribingComponentKey = 0;
    ...
    var Library = /** @class */ (function () {
        ...
        Library.prototype.getCleanGlobalContext = function () {
            var _this = this;
            if (!this._private.global.cleanGlobalContextRef['set']) {
                ...
                this._private.collectionKeys.forEach(function (collectionName) {
                    context_1[collectionName] = _this._private.collections[collectionName].public.cleanse();
                });
            }
            else {
