...
var DebugType;
(function (DebugType) {
    DebugType[DebugType["ERRORS"] = 0] = "ERRORS";
    DebugType[DebugType["ASSERT"] = 1] = "ASSERT";
    DebugType[DebugType["JOBS"] = 2] = "JOBS";
    DebugType[DebugType["EVENTS"] = 3] = "EVENTS";
})(DebugType || (DebugType = {}));
    ...
    Runtime.prototype.performInternalDataUpdate = function (job) {
        ...
        if (!this.global.collecting) {
            ...
            affectedIndexes.forEach(function (index) {
                ...
                var modifiedGroup = _this.collections[job.collection].softUpdateGroupData(index);
                _this.ingest({
...
var Collection = /** @class */ (function () {
    ...
    Collection.prototype.softUpdateGroupData = function (primaryKey, groupName) {
        ...
        var currentGroup = this.public[groupName].slice();
    ...
    Collection.prototype.includeDynamicRelatedData = function (primaryKey, data) {
        return data;
    };
    ...
    Collection.prototype.searchIndexesForPrimaryKey = function (primaryKey) {
        ...
        var keys = Object.keys(this.indexes.object);
        var foundIndexes = [];
        // for every index
        for (var i = 0; i < keys.length; i++) {
...
(function (RelationTypes) {
    ...
    // store uuid on Dep (relations = [uuid, uuid]) [cleanup on data regen]
    RelationTypes[RelationTypes["DATA_DEPENDS_ON_DATA"] = 4] = "DATA_DEPENDS_ON_DATA"; // used by findById() when run in include()
...
var RelationController = /** @class */ (function () {
    ...
    RelationController.prototype.save = function (id, type, updateThis, whenThisChanges) {
        this.relations[id] = { uuid: id, type: type, updateThis: updateThis, whenThisChanges: whenThisChanges };
    };
    RelationController.prototype.relate = function (type, updateThis, whenThisChanges, collection // needed for data relations
        ...
        switch (type) {
            ...
            case RelationTypes.COMPUTED_DEPENDS_ON_DATA:
                ...
                this.save(id, type, updateThis, whenThisChanges);
                break;
            //
            case RelationTypes.COMPUTED_DEPENDS_ON_GROUP:
                whenThisChanges.ticket(id);
                this.save(id, type, updateThis, whenThisChanges);
                break;
            //
    ...
    RelationController.prototype.update = function () { };
    RelationController.prototype.cleanup = function () { };
...
var Library = /** @class */ (function () {
    ...
    Library.prototype.ticket = function (collection, uuid) {
