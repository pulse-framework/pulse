...
var SubController = /** @class */ (function () {
    ...
    SubController.prototype.getAllDepsForProperties = function (properties) {
        var deps = new Set();
        this.trackAllDeps = true;
        var evaluated = properties();
...
function ReactWrapper(ReactComponent, depsFunc) {
    ...
    return /** @class */ (function (_super) {
        ...
        class_1.prototype.registerDeps = function (componentContainer) {
            var _a = global.subs.getAllDepsForProperties(depsFunc), deps = _a.deps, isMapData = _a.isMapData, evaluated = _a.evaluated;
            this.deps = deps;
            this.isMapData = isMapData;
            this.deps.forEach(function (dep) { return dep.subscribe(componentContainer); });
            if (isMapData)
        ...
        class_1.prototype.render = function () {
            ...
            var component;
            if (this.isMapData) {
                component = React.createElement(ReactComponent, __assign({}, this.props, this.mappedData));
            }
            else {
