...
var JobType;
(function (JobType) {
    JobType[JobType["PUBLIC_DATA_MUTATION"] = 0] = "PUBLIC_DATA_MUTATION";
    JobType[JobType["INTERNAL_DATA_MUTATION"] = 1] = "INTERNAL_DATA_MUTATION";
    JobType[JobType["INDEX_UPDATE"] = 2] = "INDEX_UPDATE";
    JobType[JobType["COMPUTED_REGEN"] = 3] = "COMPUTED_REGEN";
    JobType[JobType["GROUP_UPDATE"] = 4] = "GROUP_UPDATE";
    JobType[JobType["DEEP_PUBLIC_DATA_MUTATION"] = 5] = "DEEP_PUBLIC_DATA_MUTATION";
    JobType[JobType["BULK_INTERNAL_DATA_MUTATION"] = 6] = "BULK_INTERNAL_DATA_MUTATION";
    JobType[JobType["DELETE_INTERNAL_DATA"] = 7] = "DELETE_INTERNAL_DATA";
})(JobType || (JobType = {}));
var DebugType;
(function (DebugType) {
        ...
        objectLoop(relations, function (relationKey, relation) {
            if (relationKey === groupName)
                _this.ingest({
                    ...
                    dep: _this.global.getDep(relation.groupToRegen, relation.collection)
                });
        });
    };
        ...
        if (this.dataRelationsToComputed[key]) {
            this.dataRelationsToComputed[key].forEach(function (computedInstance) {
                ...
                _this.global.ingest({
                    ...
                    dep: _this.global.getDep(computedInstance.name, computedInstance.collection)
                });
            });
        }
    };
