...
var Dep = /** @class */ (function () {
    ...
    Dep.prototype.changed = function (newValue, config) {
        ...
        // get dynamic data
        var dataWithDynamicProperties = this.collection.injectDynamicRelatedData(newValue[this.collection.primaryKey], newValue);
        // run all callbacks and pass in dynamic data, unless important
        this.subscribersAsCallbacks.forEach(function (callback) {
            return callback(config.important
                ? __assign({}, dataWithDynamicProperties, newValue) : dataWithDynamicProperties);
        });
    };
...
var Runtime = /** @class */ (function () {
    ...
    Runtime.prototype.performJob = function (job) {
        ...
        switch (job.type) {
            ...
            case JobType.INDEX_UPDATE:
                if (!pre)
                    job.previousValue = this.loadPreviousValue(job);
            ...
            if (dependent instanceof Computed)
                ...
                if (type === Computed.name)
                    ...
                    _this.ingest({
                        ...
                        collection: dependent.updateThis.collection.name,
    ...
    Runtime.prototype.performInternalDataUpdate = function (job) {
        ...
        this.overwriteInternalData(job.collection, job.property, job.value);
    ...
    // ****************** Misc Handlers ****************** //
    Runtime.prototype.writeToPublicObject = function (collectionName, type, key, value) {
        try {
            if (type === 'indexes') {
...
var Reactive = /** @class */ (function () {
    function Reactive(collection, object, mutableProperties, type) {
...
var Module = /** @class */ (function () {
    ...
    Module.prototype.prepareNamespace = function (root) {
        ...
        // assign namespace
        this.namespace = Object.assign(Object.create(__assign({}, this.methods)), __assign({ routes: {}, indexes: {}, actions: root.actions }, root.staticData, root.computed, root.data, normalizeGroups(root.groups)));
        return root;
    };
    ...
    Module.prototype.initComputed = function (computed) {
        ...
        objectLoop(computed, function (computedName, computedFunction) {
            ...
            _this.public.privateWrite(computedName, []);
        }, this.keys.computed);
    };
    ...
    Module.prototype.stash = function (callback) {
        this.stashed.push({
    ...
    Module.prototype.flush = function () {
        this.stashed.forEach(function (stash) { return stash.callback(); });
        this.stashed = [];
    };
    return Module;
}());
...
var Library = /** @class */ (function () {
    ...
    Library.prototype.runAllOnReady = function () {
        for (var i = 0; i < this._private.collectionKeys.length; i++) {
            var collectionName = this._private.collectionKeys[i];
            var collection = this._private.collections[collectionName];
    ...
    Library.prototype.initConfig = function (config) {
    ...
    Library.prototype.mapData = function (properties, instance, _config, pulseAlias) {
        ...
        if (typeof properties === 'function') {
            ...
            normalizeMap(properties).forEach(function (_a) {
                ...
                var c = pulse._private.global.contextRef[collection];
