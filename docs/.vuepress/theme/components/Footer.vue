<template>
      ...
      <div class="container mx-auto px-6 pt-10 pb-6">
        <div class="flex flex-wrap">
          <div class="w-full md:w-1/4 text-center md:text-left">
            ...
            <ul class="mb-4">
              <li class="mt-2">
                <a href="#" class="hover:underline text-white hover:text-teal-500">FAQ</a>
              </li>
              <li class="mt-2">
                <a href="#" class="hover:underline text-white hover:text-teal-500">Help</a>
              </li>
              <li class="mt-2">
                <a href="#" class="hover:underline text-white hover:text-teal-500">Support</a>
              </li>
            </ul>
          </div>
          <div class="w-full md:w-1/4 text-center md:text-left">
            ...
            <ul class="mb-4">
              ...
              <li class="mt-2">
                <a href="#" class="hover:underline text-white hover:text-teal-500">Twitter</a>
              </li>
            </ul>
          </div>
  ...
  <!-- <footer class="bg-black text-white footer pt-20">
