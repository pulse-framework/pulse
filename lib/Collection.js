...
module.exports = class Collection {
  constructor(
    ...
    this._filtersRelatedToData = Object.create(null);
    this._filtersRelatedToGroup = Object.create(null);
  ...
  findFiltersToRegen(primaryKey, indexes) {
    const checkIndexLinks = (source, index) => {
    ...
    if (Array.isArray(indexes))
      for (let index of indexes)
        checkIndexLinks('_filtersRelatedToGroup', index);
    else checkIndexLinks('_filtersRelatedToGroup', indexes);

    checkIndexLinks('_filtersRelatedToData', primaryKey);
  }
