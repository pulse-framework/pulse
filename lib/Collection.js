...
module.exports = class Collection {
  ...
  initStorage() {
    ...
    if (this._global.storage.get() instanceof Promise)
    ...
    for (let property of persist) {
      ...
      if (data !== null) {
        if (type) {
          ...
          if (this._public.hasOwnProperty(property)) {
            if (!this._storageIsPromise) this._allowInternalChange = true;
            this._public[property] = data;
            if (!this._storageIsPromise) this._allowInternalChange = false;
          }
